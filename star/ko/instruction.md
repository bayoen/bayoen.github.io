...
1. 점수판: 게임화면을 기준으로 왼쪽은 1P, 오른쪽은 2P의 점수를 표시합니다. 3가지 [심볼](#Symbol)과, 5가지 [모드](#Mode)가 있습니다. 모든 점수는 0부터 9999까지 표시할 수 있습니다.
...
- 크라운: 왕관모양으로, 이긴 게임 수 즉, 누적 게임 스코어입니다.

누적된 점수는 [초기화](#Reset), [환경설정](#Settings)에서 변경할 수 있습니다.

_*변경하는 점수는 **바요엔-스타**의 가상 점수입니다. 뿌요뿌요 테트리스 내부의 점수에는 아무런 영향을 주지 않아요!_
