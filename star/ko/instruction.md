...
[**시연영상**](https://www.youtube.com/playlist?list=PLK_vOCD9v3gUABMGU1R_VNhv5_s-LctnE)도 있습니다!
...
- 저장: **바요엔-스타**에서는 게임데이터와 설정을 실시간 저장합니다. **바요엔-스타**가 강제종료 되더라도 일부정보를 복구할 수 있습니다. **바요엔-스타** 경로의 **data.json**로 저장합니다.
