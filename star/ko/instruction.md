...
- **바요엔-스타**는 컴퓨터 메모리 후킹으로 동작하기 때문에, 두 가지 이슈가 있습니다:
    - **뿌요뿌요 테트리스**의 동작이 느려질까 걱정할 수 있습니다.
        - **바요엔-스타**는 상당히 가볍게 만들어진 프로그램입니다. 따라서 **뿌요뿌요 테트리스** 실행의 권장사항을 만족한다면, 방송송출까지 성능저하없이 쓸 수 있을거에요! _지나치게 느려지면 <a href="https://github.com/bayoen/bayoen-star-exe/issues" class="btn" target="_blank"><strong>신고/건의</strong></a>에 신고해주세요!_
