...
3. 점수판 오버레이: 게임화면 위에 띄울 수 있는 투명한 창을 띄웁니다. 자세한 내용은 ['Overlay: 점수판 오버레이'](#Overlay)을 봐주세요!
4. 환경설정: 
5. 점수판 모드: 
...
환경설정 화면입니다. **바요엔-스타**의 외형 및 점수를 변경하고, 파일 입출력을 변경할 수 있습니다!
...
환경설정 중 '*'가 있는 항목은 방송설정을 위한 것이니, 더 자세한 내용은 [**'방송설정'**]({{ site.lang_url }}/ko/streaming.html)을 확인해 주세요!
...
**'Star+'** 모드나 **'Game'** 모드의 크기가 작으면 [환경설정](#Settings)에서 키울 수도 있습니다. 텍스트 출력으로 커스텀할 수도 있습니다!
