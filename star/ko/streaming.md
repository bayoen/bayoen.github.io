...
- OBS 캡쳐 및 크로마키 설정
    1. '소스 목록 > 윈도우 캡쳐 > 윈도우: **'[bayoen-star.exe]: bayoen-star'**'로 메인화면을 송출창에 추가합니다.
    1. 추가된 윈도우 캡쳐를 '우클릭 > 이름 바꾸기 > **'바요엔-스타-캡처'**나 마음에 드는 이름'으로 바꿔줍니다.
    1. **'바요엔-스타-캡처'**에 크로마키를 설정합니다. <br/>'우클릭 > 필터 > + > 크로마 키 > 키 색상 형식 > 심홍색'
    1. 끝났습니다! **'바요엔-스타-캡처'**를 원하는 곳에 원하는 크기로 두면 됩니다!
...
- Xsplit 캡처 및 크로마키 설정
    ...
    1. '파일명 변경'을 눌러 추가된 윈도우 캡쳐의 이름을 **'바요엔-스타-캡처'**나 마음에 드는 이름으로 바꿔줍니다.
    1. **'바요엔-스타-캡처'**의 속성에서 '색 > 키 > 크로마키 > **'바요엔-스타'**의 크로마키와 같은 색'으로 설정합니다.
    1. 그리고 **'바요엔-스타-캡처'**의 속성에서 '레이아웃 > 사진/삽화의 불필요한 부분 다듬기 > 상단 > **38 포인트**'로 설정합니다.
    1. 끝났습니다! **'바요엔-스타-캡처'**를 원하는 곳에 원하는 크기로 두면 됩니다!
